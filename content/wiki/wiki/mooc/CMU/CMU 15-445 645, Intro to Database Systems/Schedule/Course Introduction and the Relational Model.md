...
6. `DATABASE RESEARCH`
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled.png)
...
8. `Flat Files`
    - 比如使用csv文件格式，每一行代表一条记录
        ...
        ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%201.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%201.png)
...
12. `RELATIONAL MODEL`
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%202.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%202.png)
...
14. RELATIONAL MODEL: `FOREIGN KEYS`
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%203.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%203.png)
...
15. `RELATIONAL ALGEBRA`
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%204.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%204.png)
    
16. RELATIONAL ALGEBRA: `**SELECT**`
    
    根据某些过滤条件挑选出子集，输出的表结构属性仍保持不变
    
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%205.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%205.png)
    
17. RELATIONAL ALGEBRA: `PROJECTION`
    
    选择表结构的部分属性，属性的顺序也可以调整，值还可以进行简单的计算
    
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%206.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%206.png)
    
18. RELATIONAL ALGEBRA: **`UNION`**
    
    两张表结构要一样，需不需要去重（看网上其他资料都是去重的）？比如下面的<a3, 103>在结果中出现2次。顺序不重要。
    
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%207.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%207.png)
...
19. RELATIONAL ALGEBRA: `INTERSECTION`
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%208.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%208.png)
...
20. RELATIONAL ALGEBRA: `DIFFERENCE`
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%209.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%209.png)
    
21. RELATIONAL ALGEBRA: `PRODUCT`
    
    也叫笛卡尔积，或者cross join，cross product。两张表的所有组合，相当于两层for循环
    
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2010.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2010.png)
...
22. RELATIONAL ALGEBRA: `JOIN`
    ...
    **思考的时候，可以先展开为笛卡尔积（左右两栏），然后根据具体的join类型，将不符合要求的记录给移除掉。**
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2011.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2011.png)
...
23. RELATIONAL ALGEBRA: `EXTRA OPERATORS`
    ...
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2012.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2012.png)
    
24. OBSERVATION
    
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2013.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2013.png)
    
25. RELATIONAL MODEL: `QUERIES`
    
    ![Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2014.png](Course%20Introduction%20and%20the%20Relational%20Model/Untitled%2014.png)